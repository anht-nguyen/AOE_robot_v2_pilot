...
function stimLoaderRoutineBegin(snapshot) {
  return async function () {
    ...
    stimLoaderComponents.forEach( function(thisComponent) {
...
function breakPeriodRoutineBegin(snapshot) {
  return async function () {
    ...
    breakPeriodComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function interTrialIntervalRoutineBegin(snapshot) {
  return async function () {
    ...
    interTrialIntervalComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function stimVidRoutineBegin(snapshot) {
  return async function () {
    ...
    stimVidComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function executionPhaseRoutineBegin(snapshot) {
  return async function () {
    ...
    executionPhaseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function postStimIntervalRoutineBegin(snapshot) {
  return async function () {
    ...
    postStimIntervalComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
