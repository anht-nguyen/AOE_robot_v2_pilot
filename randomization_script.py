...
num_Conditions = 5  # Assuming there are 4 unique conditions
total_num_actions = 18
num_stim_rep = 4           # Each stimuli is repeated 8 times
num_blocks = 6     # The number of blocks
block_size = 12     # The number of stimuli in each block (without controls)
...
total_trials = total_num_actions * num_stim_rep  # Total should be 160
...
initial_rows = stim_table_initial[:total_num_actions]



df_experimental_trials = pd.concat([initial_rows] * num_stim_rep, ignore_index=True)
